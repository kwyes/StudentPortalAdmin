            ...
            <div class="card card-login card-plain">
                <div class="modal-header justify-content-center">
                    ...
                    <div class="header header-primary text-center">
                        ...
                        <label>
                        <?php echo $_SESSION['SemesterName'].' - '.$_SESSION['termStatus']?></label>
                    </div>
                </div>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="frame-approverPic text-center">
                                        <img src="../img/user.png" alt="approverPic"
                                            id="addSubmitMdl-approverPic" onerror="this.src='../img/user.png'"
                                            class="img-m">
                                    </div>
                                </div>
                                <div class="col-md-7">
...
<script>
    $(document).ready(function () {
        ajaxtoApprovalList('#addSubmitMdl-apprStaff');
        generateSelector('#addSubmitMdl-category', activityCategory, activityCategoryVal, 'none', '');

        var appr = $('#sSubmitMdl-apprStaff').val()
        // var imgsrc = "https://asset.bodwell.edu/OB4mpVpg/staff/" + appr + ".jpg";
        // $('#addSubmitMdl-approverPic').attr("src", imgsrc);
