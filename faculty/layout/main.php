...
?>
<input type="hidden" class="termId" name="" value="">
  ...
  <div class="content">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-4">
          ...
          <div class="card">
            <div class="card-content">
              ...
              <p class="category current-term-title"></p>
              <div class="row mg-t-20 justify-content-between">
                <div class="col-md-4">
                  <label class="dashboard-sDate"></label>
                </div>
                <div class="col-md-4 text-center">
                  <label class="dashboard-mDate"></label>
                </div>
                <div class="col-md-4 text-right">
                  <label class="dashboard-eDate"></label>
                </div>
              </div>
        ...
        <div class="card">
            <div class="card-content">
              <h4 class="card-title"><i class="material-icons-outlined">school</i><span class="dashboard-username"></span>'s Courses</h4>
              <p class="card-category"><span class="term-status"></span></p>
              <!-- <p class="category current-term-p">Current Term</p> -->
              <?="staffID".$_SESSION['staffId']?>
              <div class="table-responsive table-sales">
                <table id="dashboard-courses" class="table table-hover dashboard-enrollmentTable"
...
<?php
  include_once('studentpicFrame.html');
?>
<script type="text/javascript">
  $(document).ready(function () {
    showMyProfile();
    showCurrentTerm();
    getMyCourseListV2($('.termId').val(), '<?=$_SESSION['staffId']?>');
