  ...
  <div class="modal-dialog modal-xlg">
    <div class="modal-content">
      <div class="card card-plain">
        ...
        <input type="hidden" id="waDetailModal-subjId">
          <div class="row row-eq-height">
            <div class="col-lg-8 col-md-8 col-sm-6">
              ...
              <label class="mg-r-10">
                Teacher :
                <div class="select-container" id="wa-teacher">
              ...
              <label class="mg-r-10">
                Course :
                <div class="select-container" id="wa-course">
              ...
              <label class="mg-r-10">
                Week :
                <div class="select-container">
                  <input type='text' id='weeklyDatePicker3' class="form-control custom-form mg-lr-7 maxWidth-none datepicker" data-date-format="YYYY-MM-DD" placeholder="Select Week" />
                </div>
              </label>
            </div>
